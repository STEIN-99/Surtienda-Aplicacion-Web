...
<link rel="stylesheet" href="css/Sinicio.css">
  ...
  <form class="form-inline">
    ...
    <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="far fa-user"></i> <?php echo "".$_SESSION['usua']; ?></button>
...
<a id="yyy" href="carritodecompras.php" class="btn btn-warning " role="button">Mis compras <i class="fas fa-cart-plus"></i></a>
   </form>
</nav>
