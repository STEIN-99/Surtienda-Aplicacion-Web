...
<head>
    ...
    <title>Productos Surtienda</title>
</head>
<body>
...
<nav>
    ...
    <li><a class="activo" href="pag/Sucursales.php">Sucursales</a></li>
                <li><a class="activo" href="ayuda.php">Ayuda</a></li>
...
<?php
    ...
    <ul class="pan">
        ...
        <li class="pan-item">
        <a href="SeleccionProductos.php?ID=<?php echo $varia1[0]?>" class="pan-links" ><?php echo $varia1[1]?></a>
        </li>
